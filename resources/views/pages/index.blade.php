@section('title', 'Home | E-CLUB')

@extends('includes.layouts.layout')
...
@section('content')
    ...
    <div class="simple-banner-container">
        <div class="container-fluid simple-banner blog-banner simple-banner--full-width simple-banner--mid-height simple-banner--center text-center">
            <h1 class="verveine white-text filter-shadow-big">what's new?</h1>
            <div class="museo-sans-300 second-line m-auto w-50 white-text">
                <p><span>All the latest news and updates from Boomers Towers, plus industry insights or anything else that floats our boats really!</span></p>
            </div>
        </div>
    </div>
    ...
    <div class="common-section bg-color">
        <div class="container-wrapper">
            <div class="row justify-content-center">
                <div class="col-4 col-sm-4 col-lg-2 aos-animate" data-aos="fade-up" data-aos-offset="100" data-aos-duration="500">
                    <div class="each-achievement">
                        <svg data-v-2fe1039c="" version="1.1" id="counterIcon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="278.5 0 443 560" enable-background="new 278.5 0 443 560" xml:space="preserve"><path data-v-2fe1039c="" fill="none" stroke="#007F3D" stroke-width="10" stroke-linecap="round" stroke-linejoin="round" d="M664.26,150.2
                                ...
                                C434.854,324.419,412.249,347.023,412.249,374.81z"></path>
                        </svg>
                        <span class="count-number timer" data-from="350" data-to="3685" data-speed="1500" data-target="#yesyes">1245</span>
                        <h6>Our Members</h6>
                    </div>
                </div>
                <div class="col-4 col-sm-4 col-lg-2 aos-animate" data-aos="fade-up" data-aos-offset="100" data-aos-duration="1000">
                    <div class="each-achievement">
                        <svg data-v-2fe1039c="" version="1.1" id="counterIcon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="278.5 0 443 560" enable-background="new 278.5 0 443 560" xml:space="preserve"><path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" d="M555.187,258.005c19.991,8.186,39.195,16.056,58.405,23.909
                                ...
                                c5.229,0,9.262,0,13.843,0c3.192-8.092,6.586-16.729,10.217-25.947C504.715,304.652,493.635,304.652,481.334,304.652z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" d="M566.427,385.783c6.162,0,12.354-0.371,18.481,0.111
                                ...
                                c8.693,8.217,26.543,8.705,34.083,0.826c0.887-0.92,1.575-2.424,1.616-3.686C631.875,419.473,631.771,414.094,631.771,408.305z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" d="M650.715,543.648c-5.461-6.201-10.923-12.398-17.623-19.998
                                ...
                                C651.798,542.813,651.259,543.23,650.715,543.648z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" d="M505.369,18.121c33.167,1.205,59.164,20.058,73.104,54.254
                                ...
                                C478.337,22.982,492.046,21.115,505.369,18.121z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" d="M426.125,276.785c-7.482,16.956-13.757,32.266-20.976,47.12
                                ...
                                C419.81,279.063,421.981,278.31,426.125,276.785z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" d="M473.154,428.727c8.791-26.404,17.409-52.277,26.025-78.152
                                c0.486-0.047,0.976-0.1,1.463-0.146c8.612,25.85,17.225,51.697,26.09,78.299C508.404,428.727,491.202,428.727,473.154,428.727z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" d="M481.334,304.652c12.301,0,23.381,0,35.646,0
                                c-3.631,9.219-7.024,17.855-10.217,25.947c-4.581,0-8.614,0-13.843,0C489.546,323.047,485.655,314.33,481.334,304.652z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" d="M631.771,408.305c0,5.789,0.104,11.168-0.075,16.537
                                ...
                                C618.885,408.305,624.896,408.305,631.771,408.305z"></path></svg>
                        <span class="count-number timer" data-from="250" data-to="1800" data-speed="1500" data-target="#yesyes">1245</span>
                        <h6>General Member</h6>
                    </div>
                </div>
                <div class="col-4 col-sm-4 col-lg-2 aos-animate" data-aos="fade-up" data-aos-offset="100" data-aos-duration="1500">
                    <div class="each-achievement">
                        <svg data-v-2fe1039c="" version="1.1" id="counterIcon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="278.5 0 443 560" enable-background="new 278.5 0 443 560" xml:space="preserve"><path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" d="M368.902,412.063c-4.595,7.674-8.729,14.154-12.403,20.887
                                ...
                                c6.804-2.66,8.154-7.146,7.056-13.709c-1.626-9.693-2.157-19.57-3.226-29.367C503.72,373.021,502.586,363.537,501.498,354.047z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" d="M587.971,359.373c1.598-2.756,2.605-6.877,4.955-7.891
                                ...
                                C611.051,397.24,606.186,409.375,600.927,421.881z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" d="M634.579,544.053c-4.08-16.381-7.754-31.111-11.432-45.84
                                ...
                                C640.188,527.797,637.682,535.055,634.579,544.053z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" d="M500.806,296.363c-16.769-18.798-34.097-36.346-49.004-55.754
                                ...
                                C504.771,292.188,502.974,294.039,500.806,296.363z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" d="M290.271,429.092c5.124-17.008,8.836-33.107,14.807-48.328
                                ...
                                c-4.52,7.271-8.712,14.738-13.332,21.938c-1.153,1.799-3.391,4.088-5.164,4.121C327.696,429.209,309.944,429.092,290.271,429.092z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" d="M494.056,302.365c-9.364,6.24-18.225,12.141-27.675,18.439
                                c-11.384-21.943-22.538-43.443-34.062-65.651c4.206-1.581,7.946-3.23,11.843-4.309c1.341-0.37,3.64,0.181,4.546,1.175
                                C463.75,268.537,478.641,285.189,494.056,302.365z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" d="M569.552,255.174c-11.443,22.083-22.505,43.414-34.008,65.611
                                c-9.109-6.064-17.92-11.918-27.352-18.184c1.879-2.322,3.375-4.357,5.054-6.234c11.819-13.222,24.02-26.127,35.361-39.75
                                c4.754-5.708,9.034-7.377,15.397-3.625C565.48,253.861,567.224,254.277,569.552,255.174z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" d="M501.498,354.047c1.088,9.49,2.222,18.975,3.261,28.471
                                c1.068,9.797,1.6,19.674,3.226,29.367c1.099,6.563-0.252,11.049-7.056,13.709c-5.818-2.227-8.211-6.02-7.208-13.279
                                c2.67-19.287,4.423-38.701,6.543-58.068C500.677,354.18,501.085,354.111,501.498,354.047z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" d="M600.927,421.881c5.259-12.506,10.124-24.641,15.483-36.551
                                ...
                                c-1.872,4.996-3.021,8.08-4.277,11.434c3.28,0,5.679,0,8.746,0C625.385,403.023,624.242,400.105,622.327,395.195z"></path> <path data-v-2fe1039c="" fill-rule="evenodd" clip-rule="evenodd" d="M622.327,395.195c1.915,4.91,3.058,7.828,4.469,11.434c-3.067,0-5.466,0-8.746,0
                                C619.306,403.275,620.455,400.191,622.327,395.195z"></path></svg>
                        <span class="count-number timer" data-from="80" data-to="680" data-speed="1500" data-target="#yesyes">1245</span>
                        <h6>Associate Member</h6>
                    </div>
                </div>
                <div class="col-4 col-sm-4 col-lg-2 aos-animate" data-aos="fade-up" data-aos-offset="100" data-aos-duration="1500">
                    <div class="each-achievement">
                        <img src="{{URL::to('public/front/images/achievement/af.svg')}}" alt="Affiliate Members">
                        <span class="count-number timer" data-from="10" data-to="120" data-speed="1500" data-target="#yesyes">1245</span>
                        <h6>Affiliate Members</h6>
                    </div>
                </div>
                <div class="col-4 col-sm-4 col-lg-2 aos-animate" data-aos="fade-up" data-aos-offset="100" data-aos-duration="1500">
                    <div class="each-achievement">
                        <img src="{{URL::to('public/front/images/achievement/int.svg')}}" alt="International Members">
                        <span class="count-number timer" data-from="0" data-to="20" data-speed="1500" data-target="#yesyes">1245</span>
